    ...
    <footer className="bg-[#11253b] text-slate-400 font-sans border-t border-[#1e3e62]/40" id="global-footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <button 
                  onClick={() => window.open('https://www.perlego.com/discover', '_blank')} 
      ...
      {isSitemapOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-md animate-fade-in">
          <div className="bg-white text-slate-800 w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden border border-slate-200 flex flex-col max-h-[85vh]">
            ...
            <div className="bg-[#1e3e62] text-white px-6 py-4 flex items-center justify-between">
              <div className="flex items-center space-x-2.5">
                ...
                <h3 className="font-display font-bold text-lg">CCD Library Sitemap</h3>
              </div>
              <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <h4 className="font-sans font-bold text-slate-900 border-b border-slate-100 pb-2 flex items-center space-x-1.5 uppercase tracking-wider text-xs">
                    <Globe className="w-4 h-4 text-[#1e3e62]" />
                ...
                <div className="space-y-4">
                  <h4 className="font-sans font-bold text-slate-900 border-b border-slate-100 pb-2 flex items-center space-x-1.5 uppercase tracking-wider text-xs">
                    <Bookmark className="w-4 h-4 text-[#1e3e62]" />
