          ...
          >
            <div className="grow relative flex items-center pl-3">
              ...
              <input
                ...
                aria-label="Search catalog books and e-books on Perlego"
      ...
      <section className="bg-slate-50 border-b border-slate-200 py-16" id="home-quick-access">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <button 
              onClick={() => window.open('https://www.perlego.com/home', '_blank')}
            ...
            >
              <div>
                ...
                <p className="text-sm text-slate-500 leading-relaxed mb-6 font-normal">
                  Search books, e-books, journals, and media via Perlego.
                </p>
              </div>
            ...
            >
              <div>
                <h3 className="font-display font-bold text-lg text-slate-950 mb-2 flex items-center justify-between w-full">
                  <span>Databases</span>
                  <Database className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transition-colors shrink-0" />
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed mb-6 font-normal">
            ...
            >
              <div>
                <h3 className="font-display font-bold text-lg text-slate-950 mb-2 flex items-center justify-between w-full">
                  ...
                  <PenTool className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transition-colors shrink-0" />
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed mb-6 font-normal">
            ...
            >
              <div>
                <h3 className="font-display font-bold text-lg text-slate-950 mb-2 flex items-center justify-between w-full">
                  ...
                  <GraduationCap className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transition-colors shrink-0" />
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed mb-6 font-normal">
            ...
            >
              <div>
                <h3 className="font-display font-bold text-lg text-slate-950 mb-2 flex items-center justify-between w-full">
                  ...
                  <MessageSquare className="w-4 h-4 text-slate-400 group-hover:text-blue-600 transition-colors shrink-0" />
                </h3>
                <p className="text-sm text-slate-500 leading-relaxed mb-6 font-normal">
