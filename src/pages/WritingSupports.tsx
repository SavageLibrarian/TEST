            ...
            {modules.map((module) => {
              ...
              return (
                <div 
                  ...
                  className="group cursor-pointer bg-white p-6 rounded-2xl border border-slate-200/80 hover:border-blue-600 hover:shadow-md transition-all duration-300 flex flex-col justify-between"
                >
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="space-y-1">
                        <h3 className="font-display font-bold text-base text-slate-900 group-hover:text-blue-700 transition-colors flex items-center gap-1.5">
                          ...
                          <ExternalLink className="w-3.5 h-3.5 text-slate-400 opacity-0 group-hover:opacity-100 transition-all shrink-0" />
                        </h3>
