      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12" id="help-main-content">
        ...
        <section className="space-y-6" id="support-cards-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <button 
              onClick={() => {
                const formEl = document.getElementById('query-form-block');
                if (formEl) formEl.scrollIntoView({ behavior: 'smooth' });
              }}
              className="bg-white rounded-xl border border-slate-200/85 p-6 hover:border-blue-500 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between group focus-visible:ring-2 focus-visible:ring-[#1e3e62] focus-visible:ring-offset-2 focus:outline-none text-left cursor-pointer"
              aria-label="Scroll to support form to book a private 1-to-1 session"
            >
              <div className="space-y-4">
              ...
              <div className="pt-6 border-t border-slate-100 mt-6 flex items-center justify-between text-xs font-bold text-[#1e3e62] group-hover:text-blue-800">
        ...
        <section className="space-y-6" id="login-guides-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a 
              ...
              rel="noreferrer"
              className="bg-white rounded-xl border border-slate-200/85 p-6 hover:border-blue-500 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between group focus-visible:ring-2 focus-visible:ring-[#1e3e62] focus-visible:ring-offset-2 focus:outline-none text-left"
              aria-label="View step-by-step document guide: How to Sign Into EBSCO"
            >
              <div className="space-y-4">
            ...
            <a 
              ...
              rel="noreferrer"
              className="bg-white rounded-xl border border-slate-200/85 p-6 hover:border-blue-500 shadow-xs hover:shadow-md transition-all duration-200 flex flex-col justify-between group focus-visible:ring-2 focus-visible:ring-[#1e3e62] focus-visible:ring-offset-2 focus:outline-none text-left"
              aria-label="View step-by-step document guide: How to Sign Into Perlego"
            >
              <div className="space-y-4">
