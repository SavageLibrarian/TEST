      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8" id="guides-content-container">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="bg-[#1e3e62] p-3 rounded-xl shadow-xs transition-transform duration-300 group-hover:scale-105">
        ...
        <div className="bg-slate-100/50 rounded-2xl border border-slate-200/80 p-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="bg-white hover:bg-slate-50 border border-slate-200 hover:border-slate-300 text-slate-700 text-xs font-bold px-4 py-2.5 rounded-xl transition-all whitespace-nowrap cursor-pointer shadow-xs focus-visible:ring-2 focus-visible:ring-[#1e3e62] focus-visible:ring-offset-2 focus:outline-none"
          >
